...
$("button").click(function() {
  ...
  //if ($(this).attr("id") === "afraid") {
   // console.log ('hello')
    //$("#introText").replaceWith('<div id="introText" class = "new">' + quotes.afraid[Math.floor(Math.random() * (quotes['afraid'].length - 1))] + '</div>').append('<a href="www.twitter.com/share" class= "twitter-share-button">Tweet</a>');
  //};
...
if ($(this).attr("id") === "afraid") {
  ...
  //if ($(this).attr("id") === "stressed") {
    //$("#introText").replaceWith('<div id="introText" class="new">' + quotes.stressed[Math.floor(Math.random() * (quotes['stressed'].length - 1))] + '</div>');
 // }
if ($(this).attr("id") === "stressed") {
  ...
  //if ($(this).attr("id") === "angry") {
    //$("#introText").replaceWith('<div id="introText" class="new">' + quotes.angry[Math.floor(Math.random() * (quotes['angry'].length - 1))] + '</div>');
  //}
if ($(this).attr("id") === "angry") {
  ...
  //if ($(this).attr("id") === "random") {
   // $("#introText").replaceWith('<div id="introText" class="new">' + quotes.random[Math.floor(Math.random() * (quotes['random'].length - 1))] + '</div>');
  //}
